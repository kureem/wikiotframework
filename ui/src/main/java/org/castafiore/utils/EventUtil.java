...
public class EventUtil {
	...
	private final static java.util.Properties common = Properties.getProperties("common");
...
event.type.2=change
event.type.3=click
event.type.20=dblclick
event.type.4=focus
event.type.6=hover
event.type.7=keydown
event.type.8=keypress
event.type.9=keyup
event.type.11=mousedown
event.type.12=mousemove
event.type.13=mouseout
event.type.14=mouseover
event.type.15=mouseup
event.type.17=select
event.type.21=ready
		 */
