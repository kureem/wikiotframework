...
public class ResourceUtil {
	...
	static {
		try {
			...
			MIMETYPES_EXTENSION
					.load(Thread.currentThread().getContextClassLoader().getResourceAsStream("mimetype.properties"));
			EXTENSION_MIMETYPES
					.load(Thread.currentThread().getContextClassLoader().getResourceAsStream("extensions.properties"));
