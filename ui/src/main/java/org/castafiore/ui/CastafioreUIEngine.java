 ...
 * Oct 22, 2008
 */
public final class CastafioreUIEngine {
	...
	public CastafioreUIEngine(InterceptorRegistry interceptorRegistry) {
		super();
	...
	private   JSMap getMap(Container tag, int type)
	{
