...
public class EXFieldSet extends EXContainer implements FormInput<Map<String, ?>> {
	...
	private Container buttonsContainer = new EXContainer("buttonsContainer", "div")
			.addClass("col-lg-offset-1 col-lg-9");
	...
	public void addField(String label, FormInput<?> input) {
		addField(label, input, 1);
	}

	public void addField(Container label, FormInput<?> input) {
		addField(label, input, 1);
	}

	public void addField(FormInput<?> input) {
		addField(input, 1);
	}

	public void addField(Container label, FormInput<?> input, int spancolumn) {
	...
	public void addField(Container label, Container input, int spancolumn) {
		...
		Container inputcell = new EXContainer("cell__", "div").addClass("col-lg-" + getInputSize(spancolumn))
				.setAttribute("cols", spancolumn + "");
	...
	public List<FormInput<?>> getFields() {
		...
		// ComponentUtil.getDescendentsOfType(form, result,
