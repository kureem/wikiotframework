...
public interface HTMLTag extends Component {
	...
	/**
	 * returns attributes names accumulated during the whole life cycle of the component
	 * @return
	 */
	...
	/**
	 * returns the attribute names that have changed after the last flush was called
	 * @return
	 */
	 ...
	 * The only way I have found to prevent users from calling this method, is by passing a secret key as parameter.
	 * If ever you happen to call this method, the effect on the browser cannot be predicted
	 */
