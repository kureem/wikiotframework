...
package org.castafiore.ui.validator;
...
public class EmptyStringValidator implements Validator {
	...
	public boolean validate(Container component) {
		...
		{
			if(((FormInput)component).getValue() == null )
			{
			...
			if(((FormInput)component).getValue() != null && ((FormInput)component).getValue().toString().length() == 0)
			{
				component.setStyle("border", "dashed 1px red");
				return false;
			}
