        ...
        (function (model) {
            var AbstractComponentFactory = (function () {
                ...
                AbstractComponentFactory.prototype.configureStyles = function (instance, component) {
                    ...
                    for (var index317 = 0; index317 < keys.length; index317++) {
                        var key = keys[index317];
                        {
                ...
                AbstractComponentFactory.prototype.configureParameters = function (instance, component) {
                    ...
                    for (var index318 = 0; index318 < keys.length; index318++) {
                        var key = keys[index318];
                        {
                ...
                AbstractComponentFactory.prototype.configureEvents = function (instance, component) {
                    for (var index319 = 0; index319 < component.events.length; index319++) {
                        var event_1 = component.events[index319];
                        {
            ...
            model.AbstractComponentFactory = AbstractComponentFactory;
...
(function (framework) {
    ...
    (function (builder) {
        var model;
        (function (model) {
            var ComponentFactoryRegistry = (function () {
                function ComponentFactoryRegistry() {
                    /*private*/ this.factories = (new java.util.LinkedList());
                }
                ComponentFactoryRegistry.INSTANCE_$LI$ = function () { if (ComponentFactoryRegistry.INSTANCE == null)
                    ComponentFactoryRegistry.INSTANCE = new ComponentFactoryRegistry(); return ComponentFactoryRegistry.INSTANCE; };
                ;
                ComponentFactoryRegistry.prototype.registerFactory = function (factory) {
                    this.factories.add(factory);
                };
                ComponentFactoryRegistry.prototype.getFactory = function (impl) {
                    for (var index320 = this.factories.iterator(); index320.hasNext();) {
                        var factory = index320.next();
                        {
                ...
                ComponentFactoryRegistry.getInstance = function () {
                    return ComponentFactoryRegistry.INSTANCE_$LI$();
                };
                return ComponentFactoryRegistry;
            }());
            model.ComponentFactoryRegistry = ComponentFactoryRegistry;
...
(function (framework) {
    ...
    (function (ext) {
        var DraggableRenderer = (function () {
            ...
            DraggableRenderer.prototype.doRender$framework_Draggable$jsweet_dom_HTMLElement = function (c, root) {
                var jq = $("#" + c.getId());
            ...
            DraggableRenderer.prototype.doRender = function (c, root) {
                if (((c != null && (c["__interfaces"] != null && c["__interfaces"].indexOf("framework.Draggable") >= 0 || c.constructor != null && c.constructor["__interfaces"] != null && c.constructor["__interfaces"].indexOf("framework.Draggable") >= 0)) || c === null) && ((root != null && root instanceof HTMLElement) || root === null)) {
                    return this.doRender$framework_Draggable$jsweet_dom_HTMLElement(c, root);
                }
                else
                    throw new Error('invalid overload');
            };
...
(function (framework) {
    ...
    (function (ext) {
        var DroppableRenderer = (function () {
            ...
            DroppableRenderer.prototype.doRender$framework_Droppable$jsweet_dom_HTMLElement = function (c, root) {
                var jq = $("#" + c.getId());
            ...
            DroppableRenderer.prototype.doRender = function (c, root) {
                if (((c != null && (c["__interfaces"] != null && c["__interfaces"].indexOf("framework.Droppable") >= 0 || c.constructor != null && c.constructor["__interfaces"] != null && c.constructor["__interfaces"].indexOf("framework.Droppable") >= 0)) || c === null) && ((root != null && root instanceof HTMLElement) || root === null)) {
                    return this.doRender$framework_Droppable$jsweet_dom_HTMLElement(c, root);
                }
                else
                    throw new Error('invalid overload');
            };
        ...
        ext.DroppableRenderer = DroppableRenderer;
    ...
    (function (renderer) {
        var ContainerRenderer = (function () {
            ...
            ContainerRenderer.prototype.execCommands = function (njq, container) {
                for (var index321 = container.getCommands().iterator(); index321.hasNext();) {
                    var command = index321.next();
                    {
            ...
            ContainerRenderer.prototype.renderEvents = function (njq, c) {
                var _this = this;
                for (var index322 = c.getListeners().keySet().iterator(); index322.hasNext();) {
                    var key = index322.next();
                    {
                        var listeners = c.getListeners().get(key);
                        njq.addEventListener(key, (function (listeners) {
                            return function (evt) {
                                for (var index323 = listeners.iterator(); index323.hasNext();) {
                                    var l = index323.next();
                                    {
            ...
            ContainerRenderer.prototype.synchronizeFields = function (njq, jsfield) {
                ...
                for (var index324 = jsfield.getChildren().iterator(); index324.hasNext();) {
                    var c = index324.next();
                    {
            ...
            ContainerRenderer.prototype.renderAttributes = function (njq, c, changed) {
                if (changed) {
                    {
                        var array326 = c.getChangedAttributes();
                        for (var index325 = 0; index325 < array326.length; index325++) {
                            var key = array326[index325];
                            {
                    ...
                    for (var index327 = c.getAttributeNames().iterator(); index327.hasNext();) {
                        var key = index327.next();
                        {
                            if (c.getAttribute(key) != null)
                                njq.setAttribute(key, c.getAttribute(key));
                        }
            ...
            ContainerRenderer.prototype.renderStyles = function (njq, c, changed) {
                if (changed) {
                    {
                        var array329 = c.getChangedStyles();
                        for (var index328 = 0; index328 < array329.length; index328++) {
                            var key = array329[index328];
                            {
                    ...
                    for (var index330 = c.getStyleNames().iterator(); index330.hasNext();) {
                        var key = index330.next();
                        {
                            njq.style.setProperty(key, c.getStyle(key));
                        }
                    }
...
(function (framework) {
    ...
    (function (builder) {
        ...
        }(framework.builder.model.AbstractComponentFactory));
        builder.BasicComponentFactory = BasicComponentFactory;
...
(function (framework) {
    ...
    var JSContainer = (function () {
        ...
        JSContainer.prototype.addClass = function (styleClass) {
            ...
            var add = true;
            for (var index331 = 0; index331 < aStyles.length; index331++) {
                var style = aStyles[index331];
                {
                    if ((function (o1, o2) { if (o1 && o1.equals) {
                        return o1.equals(o2);
                    }
        ...
        JSContainer.prototype.setRendered = function (b) {
            this.rendered = b;
            if (!b) {
                for (var index332 = this.children.iterator(); index332.hasNext();) {
                    var child = index332.next();
                    {
                        child.setRendered(b);
                    }
                }
        ...
        JSContainer.prototype.render$jsweet_dom_HTMLElement = function (parent) {
            ...
            for (var index333 = this.renderers.iterator(); index333.hasNext();) {
                var renderer_1 = index333.next();
                renderer_1.doRender(this, parent);
            }
            for (var index334 = this.getChildren().iterator(); index334.hasNext();) {
                var child = index334.next();
                {
                    child.render();
                }
            }
        ...
        JSContainer.prototype.getAncestorWithClass = function (cls) {
            ...
            {
                var array336 = this.parent.getAttribute("class").split(" ");
                for (var index335 = 0; index335 < array336.length; index335++) {
                    var s = array336[index335];
                    {
                        if ((function (o1, o2) { if (o1 && o1.equals) {
                            return o1.equals(o2);
                        }
    ...
    (function (builder) {
        var Component = (function (_super) {
            ...
            function Component(name, initial, label, factory) {
                ...
                _this.addRenderer(new framework.ext.DraggableRenderer());
                return _this;
            }
            /**
             *
        ...
        Component["__interfaces"] = ["framework.Draggable", "framework.Renderable"];
    })(builder = framework.builder || (framework.builder = {}));
})(framework || (framework = {}));
(function (framework) {
    ...
    JSCheckBox["__interfaces"] = ["framework.InputField", "framework.Renderable"];
})(framework || (framework = {}));
(function (framework) {
...
(function (framework) {
    ...
    JSOption["__interfaces"] = ["framework.Renderable"];
})(framework || (framework = {}));
(function (framework) {
    var JSSelect = (function (_super) {
        ...
        JSSelect.prototype.getValue = function () {
            ...
            for (var index337 = this.getChildren().iterator(); index337.hasNext();) {
                var opt = index337.next();
                {
                    if ((function (o1, o2) { if (o1 && o1.equals) {
                        return o1.equals(o2);
                    }
        ...
        JSSelect.prototype.setValue$java_lang_String = function (val) {
            for (var index338 = this.getChildren().iterator(); index338.hasNext();) {
                var opt = index338.next();
                {
                    if ((function (o1, o2) { if (o1 && o1.equals) {
                        return o1.equals(o2);
                    }
    ...
    JSSelect["__interfaces"] = ["framework.InputField", "framework.Renderable"];
})(framework || (framework = {}));
(function (framework) {
    ...
    JSTextArea["__interfaces"] = ["framework.InputField", "framework.Renderable"];
})(framework || (framework = {}));
(function (framework) {
    var lightning;
    (function (lightning) {
...
(function (framework) {
    ...
    (function (lightning) {
        ...
        Badge["__interfaces"] = ["framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
    (function (lightning) {
        ...
        Box["__interfaces"] = ["framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
    (function (lightning) {
        ...
        BreadcrumbItem["__interfaces"] = ["framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
    (function (lightning) {
        ...
        Breadcrumbs["__interfaces"] = ["framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
        ...
        var Button = (function (_super) {
            ...
            function Button(name) {
                ...
                if (((typeof name === 'string') || name === null)) {
                    ...
                    _this.component = new framework.builder.model.Component();
                    (function () {
            ...
            Button.prototype.setState = function (state) {
                for (var index339 = 0; index339 < Button.states_$LI$().length; index339++) {
                    var s = Button.states_$LI$()[index339];
                    {
...
(function (framework) {
    ...
    (function (lightning) {
        ...
        ButtonGroup["__interfaces"] = ["framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
...
(function (framework) {
    ...
    (function (lightning) {
        ...
        CheckBox["__interfaces"] = ["framework.EventListener", "framework.InputField", "framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
    (function (lightning) {
        ...
        CheckBoxButtonGroup["__interfaces"] = ["framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
    (function (lightning) {
        ...
        DockedComposerContainer["__interfaces"] = ["framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
    (function (lightning) {
        ...
        FormElement["__interfaces"] = ["framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
...
(function (framework) {
    ...
    (function (lightning) {
        ...
        HorizontalList["__interfaces"] = ["framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
    (function (lightning) {
        var Icon = (function (_super) {
            ...
            Icon.prototype.refresh = function () {
                var html = "<svg class=\'slds-button__icon\'><use xmlns:xlink=\"http://www.w3.org/1999/xlink\" xlink:href=\"/lightning/assets/icons/utility-sprite/svg/symbols.svg#settings\"></use></svg>";
                this.setHtml(html);
            };
...
(function (framework) {
    ...
    (function (lightning) {
        ...
        Lookup["__interfaces"] = ["framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
    (function (lightning) {
        ...
        LTContainer["__interfaces"] = ["framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
...
(function (framework) {
    ...
    (function (lightning) {
        ...
        TabBody["__interfaces"] = ["framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
    (function (lightning) {
        ...
        TabItem["__interfaces"] = ["framework.EventListener", "framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
    (function (lightning) {
        var Tabs = (function (_super) {
            ...
            Tabs.prototype.setActive = function (item) {
                for (var index340 = this.nav.getChildren().iterator(); index340.hasNext();) {
                    var c = index340.next();
                    {
                        var tab = c;
        ...
        Tabs["__interfaces"] = ["framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
...
(function (framework) {
    var TestApp = (function (_super) {
        ...
        function TestApp() {
            var _this = _super.call(this, "root", "div") || this;
            _this.setStyle("width", "200px");
            _this.setStyle("height", "400px");
            _this.setStyle("border", "solid 1px silver");
            var child = new framework.JSContainer("div");
            child.setStyle("width", "100px").setStyle("height", "100px").setStyle("background-color", "steelblue");
            _this.addChild$framework_JSContainer(child);
            child.addEventListener(new TestApp.TestApp$0(_this), "click");
            return _this;
        }
        return TestApp;
    }(framework.JSContainer));
    framework.TestApp = TestApp;
    TestApp["__class"] = "framework.TestApp";
    TestApp["__interfaces"] = ["framework.Renderable"];
    (function (TestApp) {
        var TestApp$0 = (function () {
            function TestApp$0(__parent) {
                this.__parent = __parent;
            }
            /**
             *
             ...
             * @param {Event} evt
             */
            TestApp$0.prototype.performAction = function (source, evt) {
                alert("Hello world !!");
            };
            return TestApp$0;
        }());
        TestApp.TestApp$0 = TestApp$0;
        TestApp$0["__interfaces"] = ["framework.EventListener"];
    })(TestApp = framework.TestApp || (framework.TestApp = {}));
})(framework || (framework = {}));
(function (framework) {
    var builder;
    (function (builder) {
        var BasicComponent = (function (_super) {
            ...
            function BasicComponent(name, initial, label) {
                return _super.call(this, "html:" + name, initial, label, new framework.builder.BasicComponentFactory(name)) || this;
            }
        ...
        BasicComponent["__interfaces"] = ["framework.Draggable", "framework.Renderable"];
    })(builder = framework.builder || (framework.builder = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
    (function (lightning) {
        ...
        CheckBoxButton["__interfaces"] = ["framework.EventListener", "framework.InputField", "framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var builder;
    (function (builder) {
        var ComponentsLibrary = (function (_super) {
            ...
            ComponentsLibrary.prototype.addComponents = function () {
                ...
                for (var index341 = 0; index341 < components.length; index341++) {
                    var com = components[index341];
                    {
        ...
        ComponentsLibrary["__interfaces"] = ["framework.Renderable"];
    })(builder = framework.builder || (framework.builder = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
...
(function (framework) {
    ...
    (function (lightning) {
        ...
        DockedComposer["__interfaces"] = ["framework.Draggable", "framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
    (function (lightning) {
        ...
        (function (GlobalHeader) {
            ...
            GlobalHeaderItem["__interfaces"] = ["framework.Renderable"];
            ...
            SearchGlobalHeaderItem["__interfaces"] = ["framework.Renderable"];
...
(function (framework) {
    ...
    (function (lightning) {
        ...
        Panel["__interfaces"] = ["framework.Renderable"];
        (function (Panel) {
            ...
            PanelSection["__interfaces"] = ["framework.Renderable"];
    ...
    (function (builder) {
        var Builder = (function (_super) {
            ...
            function Builder(name) {
                ...
                /*private*/ _this.basicComponentLib = new framework.builder.BasicComponentLibrary();
                /*private*/ _this.lightningComponentLib = new framework.builder.LightningComponentLibrary();
        ...
        Builder["__interfaces"] = ["framework.Renderable"];
    })(builder = framework.builder || (framework.builder = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
    (function (lightning) {
        var DescriptionList = (function (_super) {
            ...
            DescriptionList.prototype.setLayout = function (layout) {
                ...
                for (var index342 = this.getChildren().iterator(); index342.hasNext();) {
                    var child = index342.next();
                    {
        ...
        DescriptionList["__interfaces"] = ["framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var lightning;
    (function (lightning) {
        ...
        FormLayout["__interfaces"] = ["framework.Renderable"];
    })(lightning = framework.lightning || (framework.lightning = {}));
})(framework || (framework = {}));
(function (framework) {
    var builder;
    (function (builder) {
        ...
        ComponentsTabs["__interfaces"] = ["framework.Renderable"];
    })(builder = framework.builder || (framework.builder = {}));
})(framework || (framework = {}));
(function (framework) {
    var builder;
    (function (builder) {
        ...
        EditorTabs["__interfaces"] = ["framework.Renderable"];
    })(builder = framework.builder || (framework.builder = {}));
})(framework || (framework = {}));
(function (framework) {
    var builder;
    (function (builder) {
        ...
        builder.BasicComponentLibrary = BasicComponentLibrary;
        BasicComponentLibrary["__class"] = "framework.builder.BasicComponentLibrary";
        BasicComponentLibrary["__interfaces"] = ["framework.Renderable"];
    })(builder = framework.builder || (framework.builder = {}));
})(framework || (framework = {}));
(function (framework) {
    var builder;
    (function (builder) {
        ...
        builder.LightningComponentLibrary = LightningComponentLibrary;
        LightningComponentLibrary["__class"] = "framework.builder.LightningComponentLibrary";
        LightningComponentLibrary["__interfaces"] = ["framework.Renderable"];
        (function (LightningComponentLibrary) {
        ...
        })(LightningComponentLibrary = builder.LightningComponentLibrary || (builder.LightningComponentLibrary = {}));
    })(builder = framework.builder || (framework.builder = {}));
})(framework || (framework = {}));
(function (framework) {
    var builder;
    (function (builder) {
        var PropertiesEditor = (function (_super) {
            ...
            PropertiesEditor.prototype.addProperty$framework_configs_Parameter = function (parameter) {
                ...
                if ((function (o1, o2) { return o1.toUpperCase() === (o2 === null ? o2 : o2.toUpperCase()); })(parameter.type, "String")) {
                    ...
                    for (var index343 = parameter.options.iterator(); index343.hasNext();) {
                        var opt = index343.next();
                        {
            ...
            PropertiesEditor.prototype.performAction = function (source, evt) {
                ...
                alert(value);
                this.component.setParameter(source.getName(), value);
            };
        ...
        PropertiesEditor["__interfaces"] = ["framework.builder.Editor", "framework.EventListener", "framework.Renderable"];
    })(builder = framework.builder || (framework.builder = {}));
})(framework || (framework = {}));
(function (framework) {
    var builder;
    (function (builder) {
        var AdvancedPropertiesEditorBody = (function (_super) {
            ...
            AdvancedPropertiesEditorBody.prototype.setComponent = function (designable) {
                ...
                this.clear();
                for (var index344 = this.component.getParameters().iterator(); index344.hasNext();) {
                    var p = index344.next();
                    {
        ...
        AdvancedPropertiesEditorBody["__interfaces"] = ["framework.builder.Editor", "framework.EventListener", "framework.Renderable"];
    })(builder = framework.builder || (framework.builder = {}));
})(framework || (framework = {}));
(function (framework) {
    var builder;
    (function (builder) {
        ...
        BasicPropertiesEditorBody["__interfaces"] = ["framework.builder.Editor", "framework.EventListener", "framework.Renderable"];
    })(builder = framework.builder || (framework.builder = {}));
})(framework || (framework = {}));
(function (framework) {
    var builder;
    (function (builder) {
        ...
        EventsEditor["__interfaces"] = ["framework.builder.Editor", "framework.EventListener", "framework.Renderable"];
    })(builder = framework.builder || (framework.builder = {}));
})(framework || (framework = {}));
